...
//    var eventBus_ = require('./eventBus_');
...
export default {
  ...
  created() {
    ...
    this.eventBus_.$on('updateWidth', self.updateWidthHandler)
    this.eventBus_.$on('compact', self.compactHandler)
    this.eventBus_.$on('setDraggable', self.setDraggableHandler)
    this.eventBus_.$on('setResizable', self.setResizableHandler)
    this.eventBus_.$on('setRowHeight', self.setRowHeightHandler)
    this.eventBus_.$on('setMaxRows', self.setMaxRowsHandler)
    this.eventBus_.$on('directionchange', self.directionchangeHandler)
    this.eventBus_.$on('setColNum', self.setColNum)
  ...
  beforeDestroy: function() {
    let self = this
    //Remove listeners
    this.eventBus_.$off('updateWidth', self.updateWidthHandler)
    this.eventBus_.$off('compact', self.compactHandler)
    this.eventBus_.$off('setDraggable', self.setDraggableHandler)
    this.eventBus_.$off('setResizable', self.setResizableHandler)
    this.eventBus_.$off('setRowHeight', self.setRowHeightHandler)
    this.eventBus_.$off('setMaxRows', self.setMaxRowsHandler)
    this.eventBus_.$off('directionchange', self.directionchangeHandler)
    this.eventBus_.$off('setColNum', self.setColNum)
