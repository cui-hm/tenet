...
<script>
  import Canbaojiaofei from  '../../components/innercomponents/canBaoJiaoFei/index'
  import Daiyufenxi from  '../../components/innercomponents/daiYuFenXi/index'
  import Yidijiuyi from  '../../components/innercomponents/yiDiJiuYi/index'
  import Jinbanyewu from  '../../components/innercomponents/jingBanYeWu/index'
  import Jijinjianguan from  '../../components/innercomponents/jiJinJianGuan/index'
  // import JinbanyewuCopy from  './InnerComponent/jingBanYeWu/indexCopy'
  import zongHwGuiYuan from  '../../components/innercomponents/jingBanYeWu/zongHeGuiYuan/index'
  ...
  export default {
    ...
    methods:{
      ...
      scrollTo(targetId) {
        ...
        let n = targetId
        let max = this.contentView.length
        if (n >= max) n = max - 1
        if (n < 0) n = 0
